...
predicted.1 <- predict(logistic.global, presabs.df, type="response")
#calculate AUC
auc(presabs.df$pres, predicted.1) #AUC = 0.882
...
#calculate probability of default for each individual in test dataset
predicted.2 <- predict(logistic.two, presabs.df, type="response")
#calculate AUC
auc(presabs.df$pres, predicted.2) #AUC = 0.691
...
library(caret)
#use model to predict probability of presence
predicted.1 <- predict(logistic.global, presabs.df, type="response")
head(predicted.1)
presabs.df$pres <- as.factor(presabs.df$pres)
#create confusion matrix
confusionMatrix(presabs.df$pres, predicted.1)
